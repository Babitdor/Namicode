...
from nova_deepagents.backends import CompositeBackend, StateBackend, StoreBackend
from nova_deepagents.backends.protocol import ExecuteResponse, SandboxBackendProtocol
from nova_deepagents.backends.utils import create_file_data, truncate_if_too_long, update_file_data
from nova_deepagents.middleware.filesystem import FileData, FilesystemMiddleware, FilesystemState
from nova_deepagents.middleware.patch_tool_calls import PatchToolCallsMiddleware
from nova_deepagents.middleware.subagents import SubAgentMiddleware
...
class TestFilesystemMiddleware:
    ...
    def test_glob_search_truncates_large_results(self):
        ...
        from nova_deepagents.backends.utils import TRUNCATION_GUIDANCE
    ...
    def test_format_content_with_line_numbers_short_lines(self):
        ...
        from nova_deepagents.backends.utils import format_content_with_line_numbers
    ...
    def test_read_file_with_long_lines_shows_continuation_markers(self):
        ...
        from nova_deepagents.backends.utils import create_file_data, format_read_response
    ...
    def test_sanitize_tool_call_id(self):
        ...
        from nova_deepagents.backends.utils import sanitize_tool_call_id
    ...
    def test_supports_execution_helper_with_composite_backend(self):
        ...
        from nova_deepagents.middleware.filesystem import _supports_execution
