...
```bash
# uv (recommended)
uv add Nova-deepagents

# pip
pip install Nova-deepagents

# poetry
poetry add Nova-deepagents
```
...
**NOTE:** You will want to use `from Nova_deepagents import async_create_deep_agent` to use the async version of `deepagents`, since MCP tools are async
