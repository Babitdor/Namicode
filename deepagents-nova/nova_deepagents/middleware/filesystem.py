...
from nova_deepagents.backends.protocol import BACKEND_TYPES as BACKEND_TYPES
...
class FilesystemMiddleware(AgentMiddleware):
    ...
    Example:
        ...
        from nova_deepagents.backends import StateBackend, StoreBackend, CompositeBackend
    ...
    def __init__(
        ...
        *,
        ...
        # Set system prompt (allow full override or None to generate dyNovacally)
    ...
    def wrap_model_call(
        ...
        # Use custom system prompt if provided, otherwise generate dyNovacally
        if self._custom_system_prompt is not None:
            system_prompt = self._custom_system_prompt
        else:
            # Build dyNovac system prompt based on available tools
