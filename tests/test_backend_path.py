...
print(
    f"directory_name after os.path.basename(skill_dir_path.rstrip('/\\\\')): {directory_name!r}"
)
print()

# Test if it contains separators
normalized_dir_name = directory_name.rstrip("/\\")
print(f"normalized_dir_name after rstrip: {normalized_dir_name!r}")
print(f"Contains os.sep ({os.sep!r}): {os.sep in normalized_dir_name}")
