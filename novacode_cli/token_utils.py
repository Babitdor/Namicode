...
def calculate_baseline_tokens(model, agent_dir: Path, system_prompt: str, assistant_id: str) -> int:
    ...
    try:
        ...
        # Fallback 1: use Anthropic SDK's native token counter (accurate, no transformers needed)
        try:
            import anthropic
        ...
        # Fallback 2: tiktoken cl100k_base is a reasonable proxy for Claude token counts
        try:
            import tiktoken
        ...
        # Fallback 3: rough character-based estimate (1 token ≈ 4 chars)
