...
from novacode_cli.vixie.server import set_idle as vixie_set_idle, set_thinking as vixie_set_thinking, set_working as vixie_set_working
...
from novacode_cli.ui.input_preparation import build_agent_config, get_agent_display_name, prepare_input_content
from novacode_cli.ui.interrupt_handlers import handle_plan_approval_interrupt, handle_question_interrupt
from novacode_cli.ui.streaming import TOOL_CATEGORIES, TOOL_ICONS, format_condensed_activity, is_internal_context_text
from novacode_cli.ui.subagent_tracking import SubagentTracker, format_duration, get_status_icon
from novacode_cli.ui.ui_elements import TokenTracker, format_tool_display, format_tool_message_content, format_tool_result_preview, render_file_operation, render_todo_list, render_tool_panel
        ...
        if is_internal_context_text(pending_text):
            ...
            if not session_state.verbose:
                try:
                    ...
                    if _Nova_dir:
                        (_Nova_dir / "context.md").write_text(pending_text, encoding="utf-8")
                except Exception:
                    pass
                pending_text = ""
                current_ai_message_id = None
