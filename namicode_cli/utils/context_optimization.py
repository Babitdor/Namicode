...
from namicode_cli.utils.context_eviction import smart_evict
from namicode_cli.utils.context_growth_tracker import get_growth_tracker
...
class ContextOptimizedAgent:
    ...
    def _setup_middleware(self) -> dict[str, Any]:
        ...
        try:
            ...
            middleware = {
                ...
                "shared_memory": ConditionalMiddleware(
                    SharedMemoryMiddleware,
                    condition=has_memory_operations,
                ),
            }
    ...
    def get_optimization_report(self) -> dict[str, Any]:
        ...
        return {
            ...
            "recommendations": self._generate_recommendations(budget_report, growth_report),
        }
    ...
    def _generate_recommendations(
        ...
        unloaded_middleware = [
            name for name, status in self.middleware.items()
        ...
        if not recommendations:
            recommendations.append("Context optimization is healthy. Continue monitoring.")
