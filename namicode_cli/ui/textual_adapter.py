...
from namicode_cli.ui.ui_elements import format_tool_display, format_tool_message_content
...
async def execute_task_textual(
    ...
    adapter._update_status(f"{agent_display_name} is thinking...")
            ...
            if interrupt_occurred:
                ...
                for interrupt_id, hitl_request in pending_interrupts.items():
                    if session_state.auto_approve:
                        ...
                        hitl_response[interrupt_id] = {"decisions": decisions}  # type: ignore
                    else:
                        ...
                        for action_request in hitl_request["action_requests"]:
                            ...
                            if (
                                ...
                                if (
                                    tool_msg_key
                                    and tool_msg_key in adapter._current_tool_messages
                                ):
