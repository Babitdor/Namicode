...
from namicode_cli._version import __version__
from namicode_cli.config.config import NAMI_CODE_ASCII
...
class WelcomeBanner(Static):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        banner_text = f"[bold #10b981]{NAMI_CODE_ASCII}[/bold #10b981]"
